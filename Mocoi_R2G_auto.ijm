...
// Author: Michael J. Siniscalchi, Kwan Lab, Yale University

// Revisions: 
// 171018 MJS use 'moco' directory in processing pipeline automatically; no user input. 'moco results' dir now a subdir of 'moco_R2G'. 
// 171106 MJS line 25 added setBatchMode to speed up processing.
...
root_dir = "C:\\Users\\Michael\\Documents\\Data & Analysis\\Processing Pipeline\\2 Moco\\";
...
for (i=0; i<data_dir.length; i++){
	...
	reg_path =  root_dir+data_dir[i]+"moco_R2G"+fs;
	results_path = reg_path+"moco results"+fs;
